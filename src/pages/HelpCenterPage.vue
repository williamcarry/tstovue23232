...
import { helpCenterNav } from '@/data/helpCenterNav'
...
// 展开折叠状态（默认展开第一个分类���
const openKeys = ref(new Set(['platform-usage']))
function isOpen(key) {
...
// 选中的子项ID
const selectedChildId = ref('platform-rules')
...
function getFaqDetailLink(url, title) {
